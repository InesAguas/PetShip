                ...
                <div class="container mt-3 p-3 pt-3 rounded-3 border" style="background-color:white;">
                    <div class="row">
                        <div class="col-3 me-2">
                            <router-link :to="'/perfil/' + utilizador.id"><img :src="utilizador.fotografia == null ? require('../../assets/default_user.jpg') : utilizador.fotografia"
                    ...
                    <div class="row mt-2">
                        ...
                        <p v-if="utilizador.telefone"><svg xmlns="http://www.w3.org/2000/svg" width="20" height="20" fill="currentColor"
                    ...
                    <div class="row">
                        ...
                        <div class="col">
                            ...
                            <button v-if="animal.etiqueta == 'Adoção' || animal.etiqueta == 'Adoption' "  @click="adotar" type="button" class="btn mt-3 ms-2"
                                style="background-color:#FD7E14; color:white" data-bs-toggle="modal"
                                data-bs-target="#exampleModal">{{ $t('paginaAnimalMsg.adotar') }}</button>
                        </div>
                    </div>
                    <div class="row">
