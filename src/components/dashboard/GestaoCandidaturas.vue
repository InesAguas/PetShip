                ...
                <tbody v-if="candidaturas">
                  <tr v-for="candidatura in candidaturas" :key="candidatura">
                    ...
                    <td style="width:10%;vertical-align: middle">
                      <button v-if="candidatura.estado != 'Cancelada' && candidatura.estado != 'Cancelled'" type="button" class="btn btn-success" @click="aceitar(candidatura)">{{$t('dashboardCandidaturas.aceitar')}}</button>
                      <svg xmlns="http://www.w3.org/2000/svg" width="25" height="25" fill="#bf1f13" class="bi bi-x-circle-fill ms-2" viewBox="0 0 16 16">
              ...
              <table v-else class="table table-hover">
                ...
                <tbody v-if="candidaturas">
                  <tr v-for="candidatura in candidaturas" :key="candidatura">
                    ...
                    <td style="width:10%;vertical-align: middle">{{candidatura.estado_anuncio ? "ok" : "nao" }}</td>
                    <td style="width:10%;vertical-align: middle">{{candidatura.estado}}</td>
                    <td style="width:10%;vertical-align: middle"><button v-if="candidatura.estado != 'Cancelada' && candidatura.estado != 'Cancelled'" type="button" class="btn btn-danger" @click="abrirModal(candidatura)" data-bs-toggle="modal"
